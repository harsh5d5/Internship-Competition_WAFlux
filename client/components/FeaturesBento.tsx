                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            {/* Mock Graph Visual */}
                            <div className="h-32 w-full bg-[#060707] rounded-xl border border-white/5 p-4 flex items-end gap-2 relative overflow-hidden group-hover:border-[#02C173]/20 transition-colors duration-500">
                    ...
                    >
                        ...
                        <div className="mt-auto space-y-3">
                            <div className="flex items-center gap-3 p-3 rounded-xl bg-[#0b141a] border border-[#02C173]/30 shadow-[0_4px_12px_rgba(0,0,0,0.2)] transform translate-x-2 transition-transform duration-300">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <div className="h-1.5 w-full max-w-[120px] bg-gray-800 rounded-full" />
                                </div>
                                <div className="w-2 h-2 rounded-full bg-green-500 shadow-[0_0_8px_rgba(34,197,94,0.8)]" />
                            </div>

                            {[1, 2].map((i) => (
                                <div key={i} className="flex items-center gap-3 p-3 rounded-xl bg-[#060707] border border-white/5 opacity-60 hover:opacity-100 hover:bg-[#0b141a] transition-all duration-300">
                                    <div className="w-8 h-8 rounded-full bg-gray-800 flex items-center justify-center text-xs text-gray-400 font-bold border border-white/10">
                                        {i === 1 ? 'MK' : 'AL'}
                                    </div>
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-center justify-between mb-1">
                                            <div className="h-2 w-16 bg-gray-800 rounded-full" />
                                            <div className="h-2 w-6 bg-gray-900 rounded-full" />
                                        </div>
                                        <div className="h-1.5 w-24 bg-gray-900 rounded-full" />
                                    </div>
                                </div>
                            ))}
                        </div>
                    ...
                    >
                        ...
                        <h3 className="text-xl font-bold text-white mb-2 relative z-10">AI Chatbots</h3>
                    ...
                    >
                        ...
                        <h3 className="text-xl font-bold text-white mb-2 relative z-10">Instant Broadcasts</h3>
                        <p className="text-gray-400 relative z-10">
